                    ...
                    foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" class="badge badge-info" data-toggle="modal" data-target="#editMenuModal<?= $r['id']; ?>">edit</a>
                                <a href="<?= base_url(); ?>menu/index/<?= $r['id']; ?>" class=" badge badge-danger" id="delete-button">delete</a>
                            </td>
                        </tr>
                        <!--MODAL  EDIT MENU-->
                        <div class="modal fade" id="editMenuModal<?= $r['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <form action="<?= base_url('menu'); ?>" method="post">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="editMenu" name="editMenu" value="<?= $r['role']; ?>">
                                                <!-- PAJAR -->
                                                <input type="hidden" name="type" value="edit" />
                                                <input type="hidden" name="editMenuId" value="<?= $r['id']; ?>" />
                                            </div>
                                        </div>
